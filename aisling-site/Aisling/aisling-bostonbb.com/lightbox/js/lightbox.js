...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      ...
      this.fileCloseImage = '/pictures/close.png';
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.build = function() {
	  ...
	  // edited this out for the next extra code $lightbox = $('#lightbox');
      $('<div/> FULL SCREEN',{'class' : 'lb-fullScreen'}).appendTo('.lb-container');
		$lightbox = $('#lightbox');

		$lightbox.find('.lb-fullScreen').on('click', function(e) {
		var img = new Image;
